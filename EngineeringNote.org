...
**  1.4 The Design of the "Fly 'n' Shoot" Game
    a. your goal -> achieve loose coupling among the active object ocmponents (ideally no sharing of any resources),
    b. minimize the commucation in terms of the frequency and size of exchanged events
    c. _pick_ the *frequently used nouns* in the problem specification(ship, missile, mines, tunnel)
    d. _assign_ *responsibilities and resources* to the identified active objects.
