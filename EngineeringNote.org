...
***     your goal -> achieve loose coupling among the active object ocmponents (ideally no sharing of any resources),
***     minimize the commucation in terms of the frequency and size of exchanged events
*** _pick_ the *frequently used nouns* in the problem specification(ship, missile, mines, tunnel)
*** _assign_ *responsibilities and resources* to the identified active objects.
